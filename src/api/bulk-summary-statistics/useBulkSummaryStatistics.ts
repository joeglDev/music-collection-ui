...
const getBulkSummaryStatistics = async (ownerParam: Owners): Promise<BulkSummaryStatisticsResponse> => {
    const res = await fetch(`http://localhost:5214/api/albums/bulk-statistics/${ownerParam}`);
